const COMMANDS = {
    ...
    skills: "Technical Skills:\n\n  <span style='color: #00ccff'>Languages</span>  : Python, JavaScript, Java, C++, HTML/CSS, SQL\n  <span style='color: #00ccff'>Frameworks</span> : React, Django REST, Spring Boot, OpenGL, TensorFlow, Keras, Android Jetpack, Streamlit\n  <span style='color: #00ccff'>Tools</span>      : PostgreSQL, MongoDB, SQLite, NumPy, Maven, Gradle, Android Studio, Visual Studio, Linux\n  <span style='color: #00ccff'>Concepts</span>   : REST APIs, Machine/Deep Learning, Reinforcement Learning, 3D Rendering, Software Security, Full-Stack",
